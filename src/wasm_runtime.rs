    ...
    for _ in 0..count {
        ...
        while !body.is_empty() {
            let instruction = match body.read_u8()? {
                ...
                0x28 => Instruction::I32Load(read_memarg(body, 2)?), 0x29 => Instruction::I64Load(read_memarg(body, 3)?),
                0x2c => Instruction::I32Load8S(read_memarg(body, 0)?), 0x2d => Instruction::I32Load8U(read_memarg(body, 0)?),
                0x2e => Instruction::I32Load16S(read_memarg(body, 1)?), 0x2f => Instruction::I32Load16U(read_memarg(body, 1)?),
                0x30 => Instruction::I64Load8S(read_memarg(body, 0)?), 0x31 => Instruction::I64Load8U(read_memarg(body, 0)?),
                0x32 => Instruction::I64Load16S(read_memarg(body, 1)?), 0x33 => Instruction::I64Load16U(read_memarg(body, 1)?),
                0x34 => Instruction::I64Load32S(read_memarg(body, 2)?), 0x35 => Instruction::I64Load32U(read_memarg(body, 2)?),
                0x36 => Instruction::I32Store(read_memarg(body, 2)?), 0x37 => Instruction::I64Store(read_memarg(body, 3)?),
                0x3a => Instruction::I32Store8(read_memarg(body, 0)?), 0x3b => Instruction::I32Store16(read_memarg(body, 1)?),
                0x3c => Instruction::I64Store8(read_memarg(body, 0)?), 0x3d => Instruction::I64Store16(read_memarg(body, 1)?),
                0x3e => Instruction::I64Store32(read_memarg(body, 2)?),
